...
ActiveRecord::Schema[7.0].define(version: 2022_12_06_151333) do
  ...
  create_table "chatrooms", force: :cascade do |t|
    ...
    t.index ["colocation_id"], name: "index_chatrooms_on_colocation_id"
  end
  ...
  create_table "events", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["colocation_id"], name: "index_events_on_colocation_id"
  end
  ...
  add_foreign_key "chatrooms", "colocations"
  add_foreign_key "events", "colocations"
